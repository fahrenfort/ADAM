function [num,status,strarray] = string2double(s,cdelim,rdelim,ddelim)
% STRING2DOUBLE converts strings into numeric values
%  [NUM, STATUS,STRARRAY] = STRING2DOUBLE(STR) 
%  
%  STRING2DOUBLE can replace STR2NUM, but avoids the insecure use of EVAL 
%  on unknown data [1]. 
%
