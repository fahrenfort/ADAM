...
switch plotn
    case 'all' %all possible plots
        ...
        switch attrib
            ...
            case {'DIANA','AGNES'}
                bannerplot(usedvars,separationstep,nobs,class,heights,objectorder)
                tree(objectorder,heights)
            case 'MONA'
                bannerplot(usedvars,separationstep,nobs,class,heights,objectorder)
            case {'PAM','FANNY'}
                silhouetteplot(sylinf,n,class)
                clusplot(x,ncluv,labclus)
            case 'CLARA'
                clusplot(x,ncluv,labclus)
        end
        choice=exitno;
...
%--------------------------------------------------------------------------
function choice = menuclus1(out,attrib,exitno)

choice=menu('Cluster analysis: ','All ','Banner plot', 'Tree plot (n<30)', 'Exit ');
switch choice
    case 1
        plotn='all';
...
%--------------------------------------------------------------------------
function choice = menuclus2(out,attrib,exitno)

choice=menu('Cluster analysis: ','All ', 'Banner', 'Exit ');
switch choice
    case 1
        plotn='all';
        whichplot(out,plotn,attrib,exitno,3,3,3,3,3,[],0,0)
...
%------------------------------------------------------------------------
function choice = menuclus3(out,attrib,exitno,labclus)
choice=menu('Cluster analysis: ','All ','Silhouette plot', 'Clusplot', 'Exit ');
switch choice
    case 1
        plotn='all';
...
%--------------------------------------------------------------------------
function choice = menuclus4(out,attrib,exitno,labclus)
choice=menu('Cluster analysis: ','All ', 'Clusplot', 'Exit ');
switch choice
    case 1
        plotn='all';
        whichplot(out,plotn,attrib,exitno,3,3,3,3,3,labclus,0,0)
