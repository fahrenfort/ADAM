function varargout=shadedErrorBar(x,y,errBar,lineProps,transparent,smootherror)
...
if ~isempty(smootherror)
    uE = smooth(uE,smootherror)';
    lE = smooth(lE,smootherror)';
    disp('smoothing error bar');
end
