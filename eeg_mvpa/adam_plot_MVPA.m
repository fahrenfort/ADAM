...
% ADAM_PLOT_MVPA generates plots of group-level classification/ERP analyses, using as input a stats
% structure generated by ADAM_COMPUTE_GROUP_MVPA, ADAM_COMPARE_MVPA_STATS, or
% ADAM_COMPUTE_GROUP_ERP. Statistical outcomes, if present, are marked/outlined. Options exist to
% plot multiple conditions in one figure (in case of line plots) or in multiple subplots. By
% default, for time-time or time-frequency maps, a blue-to-red colormap is used (instead of Matlab's
