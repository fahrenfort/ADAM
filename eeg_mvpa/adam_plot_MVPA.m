...
% ADAM_COMPUTE_GROUP_ERP. Statistical outcomes, if present, are outlined. Options exist to plot
...
% cfg.plot_order = [];
% cfg.swapaxes = true;
% cfg.referenceline = 0;   % you can plot a reference line by indicating cfg.referenceline = timepoint (in milliseconds) where it should be plotted.
% cfg.line_colors
% cfg.acclim3D
% cfg.acclim2D
% cfg.cent_acctick;
