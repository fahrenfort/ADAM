function [ FT_EEG, filename, FT_ERP, chanlocs ]= read_raw_data(filepath,filename,outpath,condSet,channelset,erp_baseline,resample_eeg,do_csd,clean_data,clean_window,shuffle_trials)
% function [ FT_EEG, filename, FT_ERP ]= read_raw_data(filepath,filename,outpath,condSet,channelset,erp_baseline,resample_eeg,do_csd,clean_data,clean_window,shuffle_trials)
...
% compute ERPs (baseline corrected, but not resampled, and still containing all channels)
FT_ERP = compute_erp_on_FT_EEG(FT_EEG,condSet,'trial','bin');
